...
const h = r => typeof r == "string",
    ...
    Ve = /###/g,
    de = r => r && r.indexOf("###") > -1 ? r.replace(Ve, ".") : r,
    he = r => !r || h(r),
    _ = (r, e, t) => {
        const s = h(e) ? e.split(".") : e;
        let i = 0;
        for (; i < s.length - 1;) {
            if (he(r)) return {};
            const n = de(s[i]);
    ...
    ge = (r, e, t) => {
        ...
        let n = e[e.length - 1],
            ...
            o = _(r, a, Object);
        for (; o.obj === void 0 && a.length;) n = `${a[a.length-1]}.${n}`, a = a.slice(0, a.length - 1), o = _(r, a, Object), o?.obj && typeof o.obj[`${o.k}.${n}`] < "u" && (o.obj = void 0);
        o.obj[`${o.k}.${n}`] = t
    },
    He = (r, e, t, s) => {
        const {
    ...
    $e = (r, e, t) => {
        for (const s in e) s !== "__proto__" && s !== "constructor" && (s in r ? h(r[s]) || r[s] instanceof String || h(e[s]) || e[s] instanceof String ? t && (r[s] = e[s]) : $e(r[s], e[s], t) : r[s] = e[s]);
        return r
    },
    U = r => r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var ze = {
...
class pe extends te {
    ...
    getResource(e, t, s, i = {}) {
        ...
        let o;
        e.indexOf(".") > -1 ? o = e.split(".") : (o = [e, t], s && (Array.isArray(s) ? o.push(...s) : h(s) && n ? o.push(...s.split(n)) : o.push(s)));
        const l = Z(this.data, o);
        return !l && !t && !s && e.indexOf(".") > -1 && (e = o[0], t = o[1], s = o.slice(2).join(".")), l || !a || !h(s) ? l : re(this.data?.[e]?.[t], s, n)
    }
    addResource(e, t, s, i, n = {
        ...
        let o = [e, t];
        s && (o = o.concat(a ? s.split(a) : s)), e.indexOf(".") > -1 && (o = e.split("."), i = t, t = o[1]), this.addNamespaces(t), ge(this.data, o, i), n.silent || this.emit("added", e, t, s, i)
    }
    addResources(e, t, s, i = {
        silent: !1
    }) {
        for (const n in s)(h(s[n]) || Array.isArray(s[n])) && this.addResource(e, t, n, s[n], {
            silent: !0
        });
    ...
    addResourceBundle(e, t, s, i, n, a = {
        ...
        let l = Z(this.data, o) || {};
        a.skipCopy || (s = JSON.parse(JSON.stringify(s))), i ? $e(l, s, n) : l = {
            ...l,
            ...s
        }, ge(this.data, o, l), a.silent || this.emit("added", e, t, s)
    }
...
function qe() {
    ...
    let t;
    return e.get = (s, i) => (t?.revoke?.(), i === Fe ? r : (r.push(i), t = Proxy.revocable(s, e), t.proxy)), Proxy.revocable(Object.create(null), e).proxy
}
...
const me = {},
    se = r => !h(r) && typeof r != "boolean" && typeof r != "number";
class ee extends te {
    constructor(e, t = {}) {
        super(), Ue(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = T.create("translator")
    }
    changeLanguage(e) {
        e && (this.language = e)
    }
    ...
    extractFromKey(e, t) {
        ...
        const a = s && e.indexOf(s) > -1,
            o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Qe(e, s, i);
        if (a && !o) {
    ...
    translate(e, t, s) {
        ...
        const n = i.returnDetails !== void 0 ? i.returnDetails : this.options.returnDetails,
        ...
        const b = g?.usedKey || o,
            ...
            S = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays,
            C = !this.i18nFormat || this.i18nFormat.handleAsObject,
            O = i.count !== void 0 && !h(i.count),
            k = ee.hasDefaultValue(i),
            F = O ? this.pluralResolver.getSuffix(c, i.count, i) : "",
            j = i.ordinal && O ? this.pluralResolver.getSuffix(c, i.count, {
                ordinal: !1
            }) : "",
            Q = O && !i.ordinal && i.count === 0,
            x = Q && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${F}`] || i[`defaultValue${j}`] || i.defaultValue;
        let m = d;
        C && !d && k && (m = x);
        const y = se(m),
            w = Object.prototype.toString.apply(m);
        if (C && m && y && N.indexOf(w) < 0 && !(h(S) && Array.isArray(m))) {
            if (!i.returnObjects && !this.options.returnObjects) {
                this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
                const v = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(b, m, {
                    ...i,
                    ns: l
                }) : `key '${o} (${this.language})' returned an object instead of string.`;
                return n ? (g.res = v, g.usedParams = this.getUsedParamsDetails(i), g) : v
            }
            if (a) {
                ...
                for (const I in m)
                    if (Object.prototype.hasOwnProperty.call(m, I)) {
                        const D = `${Y}${a}${I}`;
                        k && !d ? R[I] = this.translate(D, {
                            ...i,
                            defaultValue: se(x) ? x[I] : void 0,
                            joinArrays: !1,
                            ns: l
                        }) : R[I] = this.translate(D, {
                            ...i,
                            joinArrays: !1,
                            ns: l
                        }), R[I] === D && (R[I] = m[I])
        ...
        } else if (C && h(S) && Array.isArray(d)) d = d.join(S), d && (d = this.extendTranslation(d, e, i, s));
        else {
            let v = !1,
                R = !1;
            !this.isValidLookup(d) && k && (v = !0, d = x), this.isValidLookup(d) || (R = !0, d = o);
            const I = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && R ? void 0 : d,
                D = k && x !== d && this.options.updateMissing;
            if (R || v || D) {
                if (this.logger.log(D ? "updateKey" : "missingKey", c, u, o, D ? x : d), a) {
                ...
                const ue = ($, A, z) => {
                    const ce = k && z !== d ? z : I;
                    this.options.missingKeyHandler ? this.options.missingKeyHandler($, u, A, ce, D, i) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing($, u, A, ce, D, i), this.emit("missingKey", $, u, A, d)
                };
                this.options.saveMissing && (this.options.saveMissingPlurals && O ? M.forEach($ => {
                    const A = this.pluralResolver.getSuffixes($, i);
                    Q && i[`defaultValue${this.options.pluralSeparator}zero`] && A.indexOf(`${this.options.pluralSeparator}zero`) < 0 && A.push(`${this.options.pluralSeparator}zero`), A.forEach(z => {
                        ue([$], o + z, i[`defaultValue${z}`] || x)
                    })
                }) : ue(M, o, x))
            }
            d = this.extendTranslation(d, e, i, g, s), R && d === o && this.options.appendNamespaceToMissingKey && (d = `${u}${f}${o}`), (R || v) && this.options.parseMissingKeyHandler && (d = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${f}${o}` : o, v ? d : void 0, i))
        }
        return n ? (g.res = d, g.usedParams = this.getUsedParamsDetails(i), g) : d
    }
    extendTranslation(e, t, s, i, n) {
        if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
            ...
            const l = h(e) && (s?.interpolation?.skipOnVariables !== void 0 ? s.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables);
            let u;
            if (l) {
        ...
        const a = s.postProcess || this.options.postProcess,
            o = h(a) ? [a] : a;
        return e != null && o?.length && s.applyPostProcessor !== !1 && (e = Ee.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
            i18nResolved: {
                ...i,
    ...
    resolve(e, t = {}) {
        ...
        return h(e) && (e = [e]), e.forEach(l => {
            ...
            const p = t.count !== void 0 && !h(t.count),
                g = p && !t.ordinal && t.count === 0,
                d = t.context !== void 0 && (h(t.context) || typeof t.context == "number") && t.context !== "",
                b = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
            c.forEach(L => {
                this.isValidLookup(s) || (o = L, !me[`${b[0]}-${L}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (me[`${b[0]}-${L}`] = !0, this.logger.warn(`key "${i}" for languages "${b.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), b.forEach(N => {
                    if (this.isValidLookup(s)) return;
                    a = N;
                    const S = [f];
                    if (this.i18nFormat?.addLookupKeys) this.i18nFormat.addLookupKeys(S, f, N, L, t);
                    else {
                        let O;
                        p && (O = this.pluralResolver.getSuffix(N, t.count, t));
                        const k = `${this.options.pluralSeparator}zero`,
                            F = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
                        if (p && (t.ordinal && O.indexOf(F) === 0 && S.push(f + O.replace(F, this.options.pluralSeparator)), S.push(f + O), g && S.push(f + k)), d) {
                            const j = `${f}${this.options.contextSeparator||"_"}${t.context}`;
                            S.push(j), p && (t.ordinal && O.indexOf(F) === 0 && S.push(j + O.replace(F, this.options.pluralSeparator)), S.push(j + O), g && S.push(j + k))
                        }
                    }
                    let C;
                    for (; C = S.pop();) this.isValidLookup(s) || (n = C, s = this.getResource(N, L, C, t))
                }))
            })
        }), {
            res: s,
...
class xe {
    ...
    getBestMatchFromCodes(e) {
        ...
        return e.forEach(s => {
            ...
            t = this.options.supportedLngs.find(a => {
                if (a === n) return a;
                if (!(a.indexOf("-") < 0 && n.indexOf("-") < 0) && (a.indexOf("-") > 0 && n.indexOf("-") < 0 && a.substring(0, a.indexOf("-")) === n || a.indexOf(n) === 0 && n.length > 1)) return a
            })
    ...
    toResolveHierarchy(e, t) {
        ...
        return h(e) && (e.indexOf("-") > -1 || e.indexOf("_") > -1) ? (this.options.load !== "languageOnly" && n(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && n(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && n(this.getLanguagePartFromCode(e))) : h(e) && n(this.formatLanguageCode(e)), s.forEach(a => {
...
class Ge {
    ...
    getRule(e, t = {}) {
        ...
        try {
            ...
            if (!Intl) return this.logger.error("No Intl support, please use an Intl polyfill!"), Se;
...
const be = (r, e, t, s = ".", i = !0) => {
        let n = Me(r, e, t);
        return !n && i && h(t) && (n = re(r, t, s), n === void 0 && (n = re(e, t, s))), n
    },
    ie = r => r.replace(/\$/g, "$$$$");
class we {
    constructor(e = {}) {
        this.logger = T.create("interpolator"), this.options = e, this.format = e?.interpolation?.format || (t => t), this.init(e)
    }
    init(e = {}) {
    ...
    interpolate(e, t, s, i) {
        ...
        const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {},
            u = g => {
                if (g.indexOf(this.formatSeparator) < 0) {
                    const N = be(t, l, g, this.options.keySeparator, this.options.ignoreJSONStructure);
                ...
                const d = g.split(this.formatSeparator),
                    b = d.shift().trim(),
                    L = d.join(this.formatSeparator).trim();
                return this.format(be(t, l, b, this.options.keySeparator, this.options.ignoreJSONStructure), L, s, {
                    ...i,
                    ...t,
                    interpolationkey: b
                })
        ...
        this.resetRegExp();
        const f = i?.missingInterpolationHandler || this.options.missingInterpolationHandler,
            c = i?.interpolation?.skipOnVariables !== void 0 ? i.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables;
        return [{
            regex: this.regexpUnescape,
            safeValue: g => ie(g)
        }, {
            regex: this.regexp,
            safeValue: g => this.escapeValue ? ie(this.escape(g)) : ie(g)
        }].forEach(g => {
            for (o = 0; n = g.regex.exec(e);) {
                ...
                else !h(a) && !this.useRawValueToEscape && (a = fe(a));
                const b = g.safeValue(a);
                if (e = e.replace(n[0], b), c ? (g.regex.lastIndex += a.length, g.regex.lastIndex -= n[0].length) : g.regex.lastIndex = 0, o++, o >= this.maxReplaces) break
            }
        }), e
    }
    nest(e, t, s = {}) {
        ...
        const o = (l, u) => {
            ...
            const g = p.match(/'/g),
                d = p.match(/"/g);
            ((g?.length ?? 0) % 2 === 0 && !d || d.length % 2 !== 0) && (p = p.replace(/'/g, '"'));
            try {
                a = JSON.parse(p), u && (a = {
                    ...u,
                    ...a
                ...
                return this.logger.warn(`failed parsing options string in nesting for key ${l}`, b), `${l}${f}${p}`
            }
        ...
        for (; i = this.nestingRegexp.exec(e);) {
            ...
            if (u !== -1 && (l = i[1].slice(u).split(this.formatSeparator).map(f => f.trim()).filter(Boolean), i[1] = i[1].slice(0, u)), n = t(o.call(this, i[1].trim(), a), a), n && i[0] === e && !h(n)) return n;
            h(n) || (n = fe(n)), n || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), n = ""), l.length && (n = l.reduce((f, c) => this.format(f, c, s.lng, {
                ...s,
...
const Ze = r => {
    ...
    Oe = r => {
        ...
        return (t, s, i) => {
            ...
            let o = e[a];
            return o || (o = r(W(s), i), e[a] = o), o(t)
        }
    },
    Xe = r => (e, t, s) => r(W(t), s)(e);
class et {
    constructor(e = {}) {
    ...
    init(e, t = {
        ...
        const s = t.cacheInBuiltFormats ? Oe : Xe;
        this.formats = {
            number: s((i, n) => {
    ...
    format(e, t, s, i = {}) {
        ...
        return n.reduce((o, l) => {
            ...
            if (this.formats[u]) {
                let c = o;
                try {
                    const p = i?.formatParams?.[i.interpolationkey] || {},
                        g = p.locale || p.lng || i.locale || i.lng || s;
...
class st extends te {
    ...
    queueLoad(e, t, s, i) {
        ...
        return e.forEach(u => {
            ...
            t.forEach(c => {
                const p = `${u}|${c}`;
                !s.reload && this.store.hasResourceBundle(u, c) ? this.state[p] = 2 : this.state[p] < 0 || (this.state[p] === 1 ? a[p] === void 0 && (a[p] = !0) : (this.state[p] = 1, f = !1, a[p] === void 0 && (a[p] = !0), n[p] === void 0 && (n[p] = !0), l[c] === void 0 && (l[c] = !0)))
            }), f || (o[u] = !0)
    ...
    loaded(e, t, s) {
        ...
        this.queue.forEach(l => {
            He(l.loaded, [n], a), tt(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach(u => {
                o[u] || (o[u] = {});
                const f = l.loaded[u];
    ...
    saveMissing(e, t, s, i, n, a = {}, o = () => {}) {
        ...
        if (!(s == null || s === "")) {
            if (this.backend?.create) {
                ...
                if (u.length < 6) try {
                    let f;
                    u.length === 5 ? f = u(e, t, s, i, l) : f = u(e, t, s, i), f && typeof f.then == "function" ? f.then(c => o(null, c)).catch(o) : o(null, f)
                } catch (f) {
                    o(f)
                } else u(e, t, s, i, o, l)
...
const ne = () => ({
    ...
    Le = r => (h(r.ns) && (r.ns = [r.ns]), h(r.fallbackLng) && (r.fallbackLng = [r.fallbackLng]), h(r.fallbackNS) && (r.fallbackNS = [r.fallbackNS]), r.supportedLngs?.indexOf?.("cimode") < 0 && (r.supportedLngs = r.supportedLngs.concat(["cimode"])), typeof r.initImmediate == "boolean" && (r.initAsync = r.initImmediate), r),
    G = () => {},
    it = r => {
...
class J extends te {
    constructor(e = {}, t) {
        if (super(), this.options = Le(e), this.services = {}, this.logger = T, this.modules = {
                external: []
    ...
    init(e = {}, t) {
        ...
        if (!this.options.isClone) {
            ...
            const f = new xe(this.options);
            this.store = new pe(this.options.resources, this.options);
            const c = this.services;
            c.logger = T, c.resourceStore = this.store, c.languageUtils = f, c.pluralResolver = new Ge(f, {
            ...
            }, c.backendConnector = new st(i(this.modules.backend), c.resourceStore, c, this.options), c.backendConnector.on("*", (g, ...d) => {
                this.emit(g, ...d)
    ...
    reloadResources(e, t, s) {
        const i = B();
        return typeof e == "function" && (s = e, e = void 0), typeof t == "function" && (s = t, t = void 0), e || (e = this.languages), t || (t = this.options.ns), s || (s = G), this.services.backendConnector.reload(e, t, n => {
            i.resolve(), s(n)
        }), i
    }
    use(e) {
    ...
    changeLanguage(e, t) {
        ...
        const i = o => {
            ...
            a = o => {
                ...
                const l = h(o) ? o : o && o[0],
                    u = this.store.hasLanguageSomeTranslations(l) ? l : this.services.languageUtils.getBestMatchFromCodes(h(o) ? [o] : o);
    ...
    getFixedT(e, t, s) {
        const i = (n, a, ...o) => {
            ...
            let f;
            return l.keyPrefix && Array.isArray(n) ? f = n.map(c => (typeof c == "function" && (c = ae(c, {
                ...this.options,
                ...a
            })), `${l.keyPrefix}${u}${c}`)) : (typeof n == "function" && (n = ae(n, {
                ...this.options,
                ...a
    ...
    dir(e) {
        ...
        const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"],
            s = this.services?.languageUtils || new xe(ne());
    ...
    cloneInstance(e = {}, t = G) {
        ...
        if ((e.debug !== void 0 || e.prefix !== void 0) && (n.logger = n.logger.clone(e)), ["store", "services", "language"].forEach(o => {
            ...
            n.store = new pe(o, i), n.services.resourceStore = n.store
        }
        if (e.interpolation) {
            const l = {
                    ...ne().interpolation,
            ...
            n.services.interpolator = new we(u)
        }
        return n.translator = new ee(n.services, i), n.translator.on("*", (o, ...l) => {
            n.emit(o, ...l)
...
const nt = (r, e, t, s) => {
        ...
        if (r?.services?.logger?.forward) return r.services.logger.forward(i, "warn", "react-i18next::", !0);
        K(i[0]) && (i[0] = `react-i18next:: ${i[0]}`), r?.services?.logger?.warn && r.services.logger.warn(...i)
    },
    ve = {},
    Ie = (r, e, t, s) => {
        K(t) && ve[t] || (K(t) && (ve[t] = new Date), nt(r, e, t, s))
    },
    Te = (r, e) => () => {
    ...
    oe = (r, e, t) => {
        r.loadNamespaces(e, Te(r, t))
    },
    Ce = (r, e, t, s) => {
        if (K(t) && (t = [t]), r.options.preload && r.options.preload.indexOf(e) > -1) return oe(r, t, s);
        t.forEach(i => {
            r.options.ns.indexOf(i) < 0 && r.options.ns.push(i)
        }), r.loadLanguages(e, Te(r, s))
    },
    rt = (r, e, t = {}) => !e.languages || !e.languages.length ? (Ie(e, "NO_LANGUAGES", "i18n.languages were undefined or empty", {
        languages: e.languages
    }), !0) : e.hasLoadedNamespace(r, {
        lng: t.lng,
        precheck: (s, i) => {
            if (t.bindI18n && t.bindI18n.indexOf("languageChanging") > -1 && s.services.backendConnector.backend && s.isLanguageChangingTo && !i(s.isLanguageChangingTo, r)) return !1
        }
    }),
    K = r => typeof r == "string",
    at = r => typeof r == "object" && r !== null,
    ot = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g,
    lt = {
        "&amp;": "&",
        "&#38;": "&",
        "&lt;": "<",
...
var xt = Ke();
const yt = (r, e) => K(e) ? e : at(e) && K(e.defaultValue) ? e.defaultValue : Array.isArray(r) ? r[r.length - 1] : r,
    St = {
        t: yt,
        ready: !1
    },
    ...
    Vt = (r, e = {}) => {
        const {
            ...
            i18n: s,
            defaultNS: i
        } = E.useContext(pt) || {}, n = t || s || gt();
        n && !n.reportNamespaces && (n.reportNamespaces = new mt), n || Ie(n, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
        const a = E.useMemo(() => ({
                ...dt(),
                ...n?.options?.react,
                ...e
            ...
            u = i || n?.options?.defaultNS,
            f = K(u) ? [u] : u || ["translation"],
            c = E.useMemo(() => f, f);
        n?.reportNamespaces?.addUsedNamespaces?.(c);
        const p = E.useRef(0),
            g = E.useCallback(x => {
                if (!n) return bt;
                const {
                ...
                return m && n.on(m, w), y && n.store.on(y, w), () => {
                    m && m.split(" ").forEach(v => n.off(v, w)), y && y.split(" ").forEach(v => n.store.off(v, w))
                }
            }, [n, a]),
            d = E.useRef(),
            b = E.useCallback(() => {
                if (!n) return St;
                const x = !!(n.isInitialized || n.initializedStoreOnce) && c.every(Y => rt(Y, n, a)),
                    m = e.lng || n.language,
                    y = p.current,
                    w = d.current;
                if (w && w.ready === x && w.lng === m && w.keyPrefix === l && w.revision === y) return w;
                const R = {
                    t: n.getFixedT(m, a.nsMode === "fallback" ? c : c[0], l),
                    ready: x,
                    lng: m,
                    keyPrefix: l,
                    revision: y
            ...
            [L, N] = E.useState(0),
            {
                t: S,
                ready: C
            } = xt.useSyncExternalStore(g, b, b);
        E.useEffect(() => {
            if (n && !C && !o) {
                const x = () => N(m => m + 1);
                e.lng ? Ce(n, e.lng, c, x) : oe(n, c, x)
            }
        }, [n, e.lng, c, C, o, L]);
        const O = n || {},
            k = E.useRef(null),
            ...
            j = x => {
                ...
                const y = Object.create(Object.getPrototypeOf(x), m);
                if (!Object.prototype.hasOwnProperty.call(y, "__original")) try {
            ...
            Q = E.useMemo(() => {
                const x = O,
                    m = x?.language;
                let y = x;
                x && (k.current && k.current.__original === x ? F.current !== m ? (y = j(x), k.current = y, F.current = m) : y = k.current : (y = j(x), k.current = y, F.current = m));
                const w = [S, y, C];
                return w.t = S, w.i18n = y, w.ready = C, w
            }, [S, O, C, O.resolvedLanguage, O.language, O.languages]);
        if (n && o && !C) throw new Promise(x => {
            const m = () => x();
            e.lng ? Ce(n, e.lng, c, m) : oe(n, c, m)
        });
        return Q
    },
    {
...
function Lt(r) {
    return Ot.call(wt.call(arguments, 1), e => {
        if (e)
...
const ke = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
    Ct = function(r, e) {
        ...
        if (s.path) {
            if (!ke.test(s.path)) throw new TypeError("option path is invalid");
            n += `; Path=${s.path}`
        }
        if (s.expires) {
        ...
        if (s.httpOnly && (n += "; HttpOnly"), s.secure && (n += "; Secure"), s.sameSite) switch (typeof s.sameSite == "string" ? s.sameSite.toLowerCase() : s.sameSite) {
            case !0:
                n += "; SameSite=Strict";
                break;
            case "lax":
    ...
    Re = {
        create(r, e, t, s) {
            ...
            t && (i.expires = new Date, i.expires.setTime(i.expires.getTime() + t * 60 * 1e3)), s && (i.domain = s), document.cookie = Ct(r, e, i)
        },
        read(r) {
            const e = `${r}=`,
...
var kt = {
        ...
        lookup(r) {
            ...
            if (e && typeof document < "u") return Re.read(e) || void 0
        },
        cacheUserLanguage(r, e) {
            ...
            t && typeof document < "u" && Re.create(t, r, s, i, n)
        }
    },
    Rt = {
        name: "querystring",
...
var Nt = {
    ...
    lookup(r) {
        ...
        if (e && Pe()) return window.localStorage.getItem(e) || void 0
    },
    cacheUserLanguage(r, e) {
        let {
...
const Ne = () => {
    if (H !== null) return H;
    try {
        if (H = typeof window < "u" && window.sessionStorage !== null, !H) return !1;
        const r = "i18next.translate.boo";
...
const Ae = ["querystring", "cookie", "localStorage", "sessionStorage", "navigator", "htmlTag"];
De || Ae.splice(1, 1);
const jt = () => ({
    order: Ae,
...
class Dt {
    ...
    init() {
        ...
        this.services = e, this.options = Lt(t, this.options || {}, jt()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = i => i.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = s, this.addDetector(kt), this.addDetector(Rt), this.addDetector(Nt), this.addDetector($t), this.addDetector(Et), this.addDetector(Ft), this.addDetector(It), this.addDetector(Tt), this.addDetector(Pt)
    }
    addDetector(e) {
    ...
    detect() {
        ...
        }), t = t.filter(s => s != null && !vt(s)).map(s => this.options.convertDetectedLanguage(s)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null
    }
    cacheUserLanguage(e) {
...
export {
    Dt as B, Ut as a, P as i, Vt as u
};