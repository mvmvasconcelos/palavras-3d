...
```
backend/models/cortador_cookie/bambu_template/
│
...
6. **Copie os arquivos atualizados** para o template do modelo:
   ...
   |---|---|
   | `Metadata/project_settings.config` | `backend/models/cortador_cookie/bambu_template/static/Metadata/project_settings.config` |
   | `Metadata/filament_sequence.json` | `backend/models/cortador_cookie/bambu_template/static/Metadata/filament_sequence.json` |
   | `Metadata/slice_info.config` | `backend/models/cortador_cookie/bambu_template/static/Metadata/slice_info.config` |
...
1. Crie a estrutura de diretórios:
   ```
   backend/models/name_topper/bambu_template/
   └── static/
       ├── [Content_Types].xml
       ├── _rels/.rels
